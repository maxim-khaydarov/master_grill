...
public class GridViewAddAdapter extends ArrayAdapter {
    private Context context;
    private int layoutResourceId;
    private ArrayList data = new ArrayList();

    public GridViewAddAdapter(Context context, int layoutResourceId, ArrayList data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (row == null) {
            ...
            holder.coast = (TextView) row.findViewById(R.id.textView19);
        ...
        holder.coast.setText(item.getColum());
